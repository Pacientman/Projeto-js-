...
if (!location.href.includes('operabrowserjs=no')) {
  ;(function (document) {
    ...
    const createTextNode = copyMethod(
    ...
    const PATCHES = {
      ...
      'PATCH-1220': {
        description:
          'pretend to be Chrome on talkgadget to not force ' +
          'plugin download.',
        isMatching: () =>
          hostname.includes('.google.') && hostname.startsWith('talkgadget'),
      ...
      1: {
        description:
          'Browser.js status and version reported on browser.js ' +
          'documentation page',
        isMatching: () =>
          isPartOfDomain('opera.com') &&
          pathname.startsWith('/docs/browserjs/'),
        applyOnDOMReady: true,
        apply: () => {
          const bjElement = querySelector(document, '#browserjs_active')
          const bjMessage = querySelector(document, '#browserjs_status_message')
          if (bjElement) {
      ...
      'PATCH-1269': {
        ...
        isMatching: () =>
          hostname.startsWith('images.google.') ||
      ...
      'DNA-69435': {
        ...
        isMatching: () =>
          hostname.startsWith('yandex') && pathname.startsWith('/search/'),
        apply: () => {
      ...
      'DNA-90739': {
        ...
        isMatching: () =>
          isPartOfDomain('opera.atlassian.net') &&
        ...
        apply: async () => {
          ...
          if (
            ...
            pathname.includes('servicedesk/customer/portal/18/group/32/create/')
          ) {
      ...
      'DNA-90251': {
        ...
        isMatching: () =>
          isPartOfDomain('chrome.google.com') &&
